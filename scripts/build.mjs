...
const authSpec=await fs.readFile('public/auth-spec.js','utf8');
const authUiSecure=await fs.readFile('public/auth-ui-secure.js','utf8');
const spotifySpec=await fs.readFile('public/spotify-spec.js','utf8');
